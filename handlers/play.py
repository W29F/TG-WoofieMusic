...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7cbff55bd1672c2127812.png"
...
async def jiosaavn(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/7cbff55bd1672c2127812.png",
        caption=f"#️⃣ Your requested song queued at position {position}.",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Owner", url="https://t.me/privatener")]]
        ),
        parse_mode="markdown") 
        await res.delete()
    else:
        ...
        await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"▶️ Playing `{sname}` Via [Owner](https://t.me/privatener)",
        photo="https://telegra.ph/file/7cbff55bd1672c2127812.png",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Owner", url="https://t.me/privatener")]]
        ),
